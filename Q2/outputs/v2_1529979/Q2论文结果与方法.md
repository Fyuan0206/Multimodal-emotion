...
![主实验](figures/main_comparison.png)
...
![缺失长度](figures/missing_length_effect.png)

![缺失网格](figures/missing_grid_common.png)

## 验证可视化及错误分析

![验证](figures/validation_overview.png)

![误差](figures/error_distributions.png)
...
![附件3](figures/attachment3_overview.png)
